...
const Content = ({ buildTime }) => (
  <>
    <p>Site generated with <a href="https://github.com/carbon-design-system/gatsby-theme-carbon">Gatsby Carbon</a> at {buildTime}.</p>
    <p>Curated with love ❤ and your contributions are welcome!</p>
  </>

  //More about Gatsby component shadowing https://www.gatsbyjs.org/docs/themes/api-reference/#component-shadowing
);

const links = {
  firstCol: [
    { href: 'https://github.com/QPod/docker-images', linkText: 'QPod/docker-images' },
  ],
  secondCol: [
    { href: 'https://github.com/QPod/aloha', linkText: 'QPod/aloha' },
  ],
};
